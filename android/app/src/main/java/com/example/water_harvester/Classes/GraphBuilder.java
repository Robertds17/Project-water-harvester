...
public class GraphBuilder {
    private static PieChartData BuildPieChartData(long value, String label, String centerText1, String centerText2, int fontSize, int color){
    ...
    public static PieChartData BuildAmbientTempPieChartData(long value, int color){
        return BuildPieChartData(value * 2, value + "°C", "Ambient", "temperature", 10, color);
    }

    public static PieChartData BuildAmbientHumPieChartData(long value, int color){
        return BuildPieChartData(value, value + "%", "Ambient", "humidity", 10, color);
    }

    public static PieChartData BuildInsideTempPieChartData(long value, int color){
        return BuildPieChartData(value * 2, value + "°C", "Inside", "temperature", 10, color);
    }

    public static PieChartData BuildInsideHumPieChartData(long value, int color){
        return BuildPieChartData(value, value + "%", "Inside", "humidity", 10, color);
    }

    public static PieChartData BuildFanRPMPieChartData(long value, int color){
